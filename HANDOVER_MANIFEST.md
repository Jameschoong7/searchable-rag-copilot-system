...
| Release tag | `v1.0.2-company-handover` |
| Tagged ZIP filename | `searchable-rag-copilot-system-v1.0.2-company-handover.zip` |
...
`v1.0.2-company-handover` tag target shown by Git/GitHub is authoritative.
...
git show --no-patch --decorate v1.0.2-company-handover
git rev-list -n 1 v1.0.2-company-handover
```
